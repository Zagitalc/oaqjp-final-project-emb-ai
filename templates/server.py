'''
This is the server for Emotion Detector Application
'''
...
def emot_analyzer():
    '''This file receives the text from the HTML interface and 
        runs emotion detection analysis over it using emot_analyzer()'''
